...
namespace ChooseName
{
    class Consts
    {
        ...
        public const string PrintName = @"\העברה_בנקאית_להדפסה.pdf";
        public const string Subject = "העברה בנקאית ";
        public const string Title = "העברה בנקאית";
        public const string EndOfPageSeperator = "כ\"הס";
        public static System.util.RectangleJ AccountArea = new System.util.RectangleJ(200, 685, 350, 35);
